const CACHE="btec-jo-v2";
const CORE=["./","./index.html","./style.css","./responsive.css","./navigation.js","./navigation.css","./script.js","./manifest.webmanifest","/assets/btec-jo-logo.svg"];
